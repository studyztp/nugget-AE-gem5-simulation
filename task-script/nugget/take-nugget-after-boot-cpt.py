...
m5out_output_dir = Path(m5out_output_dir/f"nugget/nugget-after-boot-m5out/{arch}-m5out/")
checkpoint_output_dir = Path(checkpoint_output_dir/f"nugget-after-boot-cpt/")
...
cmd = [
    ...
    f"{workdir.as_posix()}/script/nugget/take-nugget-after-boot-cpt.py",
